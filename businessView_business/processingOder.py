...
class processingOder(Common):
    ...
    ryxz1 = (By.XPATH,"/html/body/div[37]/div[2]/div/div/div[2]/div/div/div[2]/div/div/div[2]/table/tbody/tr[1]/td[1]/div/label/span/input")
    ryxz2 = (By.XPATH,"/html/body/div[37]/div[2]/div/div/div[3]/div/button[2]")
    ...
    njxz1 = (By.XPATH,"/html/body/div[38]/div[2]/div/div/div[2]/div/div/div[2]/div/div/div[2]/table/tbody/tr[1]/td[1]/div/label/span/input")
    njxz2 = (By.XPATH,"/html/body/div[38]/div[2]/div/div/div[3]/div/button[2]")
    ...
    def processing_order(self,type,OrderNumber):
        # self.driver.find_element(*self.zyglBtn).click()
        self.driver.implicitly_wait(10)
        self.driver.find_element(*self.fwzxBtn).click()
        time.sleep(2)
        if type == "农资订单":
            logging.info("====start processing nongzi order====")
            self.driver.implicitly_wait(5)
            self.driver.find_element(*self.nzcgBtn).click()
            logging.info("search order number is %s"%OrderNumber)
            time.sleep(1.5)
            self.driver.find_element(*self.njsearch).send_keys(OrderNumber)
            ...
            logging.info("====start processing nongji order====")
            time.sleep(1)
            ...
            time.sleep(2)
            try:
                element = self.driver.find_element(*self.ryxz1)
            except NoSuchElementException:
                logging.error("no server renyuan")
                self.getScreenShot("processing order fail")
            else:
                element.click()
    ...
    def processing_servering_order(self,type,OrderNumber):
            ...
            if type == "农机订单":
                ...
                self.driver.implicitly_wait(5)
                logging.info("search order number")
                self.driver.find_element_by_xpath("/html/body/div[1]/div[2]/div/div[2]/div/div/div[3]/div/div[2]/div/div/div/div[1]/div[2]/div/div[3]/input").send_keys(OrderNumber)
                self.driver.find_element_by_xpath("/html/body/div[1]/div[2]/div/div[2]/div/div/div[3]/div/div[2]/div/div/div/div[1]/div[2]/div/div[3]/input").send_keys(Keys.ENTER)
                time.sleep(1.5)
                try:
...
if __name__ == '__main__':
    ...
    c.processing_order('农资订单',22201907251716370009)
    c.check_processing_waiting_server_order_status()
    c.processing_servering_order('农资订单',21201907260916570009)
