...
class processingOder(Common):
    ...
    njfwBtn = (By.XPATH,"/html/body/div[1]/div[2]/div/div[2]/div/div/div[3]/div/div[2]/div/div/div/div[1]/div[1]/div/ul/li[1]")
    ...
    def processing_order_dfw(self,type,oderNumber):
        ...
        if type == "找农资":
            ...
            logging.info("====start processing nongji order_dfw====")
            time.sleep(1)
            self.driver.find_element(*self.njfwBtn).click()
            time.sleep(3)
            logging.info(oderNumber)
            self.driver.find_element(*self.njsearch).send_keys(oderNumber)
            ...
            try:
                ...
                element.click()
            time.sleep(2)
            self.driver.find_element_by_xpath("/html/body/div[16]/div[2]/div/div/div[2]/div/div[1]/ul/li[2]/span[1]").click()
    ...
    def processing_order(self,type,orderNumber):
        ...
        if type == "找农资":
            ...
            logging.info("====orderNumber is %s===="%orderNumber)
    ...
    def check_processing_servering_order_status(self):
        ...
        try:
            ...
            logging.info('processing order Sucess!')
            return True
...
if __name__ == '__main__':
    ...
    # c.processing_order_dfw('农机订单')
    c.processing_order('农资订单',22201908151108320009)
    c.check_processing_waiting_server_order_status()
    c.processing_servering_order('农资订单',22201908151108320009)
